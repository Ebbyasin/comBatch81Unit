...
public class notlar {
    ...
    Bu kod sayfa acilmadiysa verilen sure kadar bekler ve sayfa içerisinde çalışırken karşılaştığı yüklenmemis
    elementleri de
    ...
    Özellikle bekletmek istediğimiz elementlerin öncesinde ayarladığımız sure ve koşuldur.Koşul gerçekleşince surenin
     dolmasini beklemez.
    ...
    örneğin; dosya indirilene kdar bekle, veya dosyanin inmesini 15 sn bekle gibi...
       ...
       --> sonrasinda 2. satirda (2) wait.until() yazarak parantez içine ExpectedConditions + nokta basarak uygun
        şartı belirleriz.
       ...
       Ornegin;
        ...
        Birde ek olarak FluentWait vardir. o da her 2 saniyede bir çalışmayı dene demektir. dosya indi mi inmedi
        mi diye loop yapiyor denebilir.
